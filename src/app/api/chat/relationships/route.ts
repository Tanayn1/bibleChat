...
const TEMPLATE = `The Topic of this conversation is about relationships, Answer the user's questions (that are about relationships) based on the bible verse that is provided (if there is one), 
