  ...
  return (
    <div >
        ...
        <div className=' mt-4 flex w-full '>
            ...
            <div className=' bg-zinc-950 mx-16 rounded-2xl relative'>
                ...
                <div className=' absolute bottom-0 left-0 right-0 flex flex-col items-center'>
                    ...
                    <h1 className=' font-serif text-lg w-[400px] text-center'>"Blessed are the peacemakers, for they will be called children of God."</h1>
        ...
        <div className=' flex  my-7  '>
            <Link href={'/dashboard/startNewChat/createPrayer'}>
                <div className=' cursor-pointer ml-8 mx-4 bg-zinc-950 rounded-xl transform transition-transform duration-300 hover:scale-105'>
            ...
            <Link href={'/dashboard/startNewChat/healMyPain'}>
                <div className='cursor-pointer mx-4 bg-zinc-950 rounded-xl transform transition-transform duration-300 hover:scale-105'>
                    <div className='fade-mask-bottom  '>
